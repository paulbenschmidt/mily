...
- 2025-11-14:
    ...
    - I spent time thinking about the best way to distribute the product. I was hoping that Reddit would be a quick way to gain lots of users, but after reading the rules of the different communities, I learned that they were all pretty aggressively against self-promotion.
    - I also fixed a bug on email verification where the CSRF token was not being set on the initial email-verification request, causing a failure.
- 2025-11-12:
