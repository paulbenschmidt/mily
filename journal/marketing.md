...
- Months 1-2:
    ...
    - [ ] Find and deeply engage 15 users (primary focus)
...
- Month 3:
    - [ ] Approach 5 partnerships with your case studies and user stories
    - [ ] Consider paid micro-targeted ads ($100-200 test budget) to communities like life coaches if organic isn't moving fast enough
- Months 4+:
    - [ ] Revisit content strategy only if you have consistent user stories to share
    - [ ] Consider Substack/Medium newsletter to existing users, not as acquisition

The hard truth: At this stage, nothing beats talking to humans one-on-one. Every hour you spend writing blog posts that no one reads is an hour you didn't spend finding user #7 or #8. Get to 15 users who genuinely love this, and your path forward will become much clearer - they'll tell you where to find more people like them.

### Competitors
- https://apps.apple.com/us/iphone/search?term=timeline
    - There aren't very many apps, and they're all pretty low quality
- Android competitor: https://play.google.com/store/apps/details?id=org.familysearch.mobile.memories&hl=en-US
    - 1M+ downloads

### Get Featured On
- https://meminto.com/blog/how-to-create-a-personal-life-timeline/#elementor-toc__heading-anchor-4
    - These seem like a direct competitor, but their focus is on creating hard-cover books. Maybe a partnership?
    - Here'a video: https://www.youtube.com/watch?v=YyNGt6AUD_E
- These might not want to feature you because they're selling slide templates
    - https://slideuplift.com/blog/personal-timeline-examples/
    - https://dreamdashjournal.com/personal-timeline-examples-pdf/
